...
public class TelaCadProcesso extends javax.swing.JFrame {
    ...
    private void id() {
        try {
            String sql = "SELECT GEN_ID(INC_IDPROCESSO, 0) FROM RDB$DATABASE";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();

            if (rs.next()) {
                int valorGenerator = rs.getInt(1);
                txtId.setText(String.valueOf(valorGenerator + 1));
            } else {
                // Se por algum motivo não conseguir pegar o valor do generator, você pode definir um valor padrão
                txtId.setText("1");
            }
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(cboAdv, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
