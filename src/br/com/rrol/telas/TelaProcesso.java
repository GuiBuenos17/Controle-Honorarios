...
public class TelaProcesso extends javax.swing.JFrame {
    ...
    private void salvar() {
        String sql = "update tbprocessos set nome = ?, cpf_cnpj = ?, nprocesso = ?, advogado = ?, gcpj = ?, agencia  = ?,conta = ?, carteira = ?, contrato = ?, stsvolu = ?, valorvolu = ?, stsacordo = ?, valoracordo = ?, porcentvolu = ?, iduser = ? where idprocesso = ?";
    ...
    private void initComponents() {
        ...
        btnAcordo = new javax.swing.JButton();
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 13, -1, 20));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel2.setText("GCPJ:");
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 48, -1, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setText("CPF/CNPJ:");
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 77, -1, 18));

        processo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        processo.setText("Nº Processo:");
        jPanel4.add(processo, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 108, -1, -1));

        cboAdv.setEnabled(false);
        cboAdv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboAdvActionPerformed(evt);
            }
        });
        jPanel4.add(cboAdv, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 136, 160, 22));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel9.setText("Advogado:");
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 138, -1, 18));

        txtNome.setEditable(false);
        jPanel4.add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 13, 160, -1));

        txtGcpj.setEditable(false);
        jPanel4.add(txtGcpj, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 44, 90, -1));

        txtDoc.setEditable(false);
        jPanel4.add(txtDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 76, 160, -1));

        txtNProcesso.setEditable(false);
        jPanel4.add(txtNProcesso, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 105, 160, -1));
        jPanel4.add(lblIdAdv, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 145, 15, -1));
        ...
        btnAcordo.setText("Novo");
        btnAcordo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAcordoActionPerformed(evt);
            }
        });
            ...
            .addGroup(menAcordoLayout.createSequentialGroup()
                ...
                .addGroup(menAcordoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, menAcordoLayout.createSequentialGroup()
                        ...
                        .addGap(186, 186, 186))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, menAcordoLayout.createSequentialGroup()
                        .addComponent(btnAcordo, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(408, 408, 408))))
        );
    ...
    private void btnAcordoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcordoActionPerformed
        // TODO add your handling code here:
        new TelaCadAcordo().setVisible(true);
    }//GEN-LAST:event_btnAcordoActionPerformed
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static javax.swing.JButton btnAcordo;
